    ...
    <div class="container container-margin mb-5">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-6 col-md-9 bg-light py-3">
                <h5 class="display-6 fw-bold text-center">Tambah Album</h5>
                <form action="proses_album.php" method="post">
                    <label for="NamaAlbum">Nama Album</label>
                    <input type="text" class="form-control mb-2" id="NamaAlbum" name="NamaAlbum" placeholder="klik dan ketik disini..." >
                    <label for="Deskripsi">Deskripsi</label>
                    <textarea name="Deskripsi" id="Deskripsi" cols="30" rows="5" class="form-control mb-2" placeholder="klik dan ketik disini..."></textarea>

        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-6 col-md-9 bg-light py-3">
                ...
                ?>
                    ...
                    <input type="text" class="form-control mb-2" id="JudulFoto" name="JudulFoto" placeholder="klik dan ketik disini..." value="<?= $data['JudulFoto'] ?>">
                    <label for="DeskripsiFoto">Deskripsi Foto</label>
                    <textarea name="DeskripsiFoto" id="DeskripsiFoto" cols="30" rows="5" class="form-control mb-2" placeholder="klik dan ketik disini..."><?= $data['DeskripsiFoto'] ?></textarea>
                    <label for="inputFoto" style="display: block;">Foto</label>
                    <img src="gambar/<?= $data['LokasiFile'] ?>" alt="<?= $data['JudulFoto'] ?>" id="imgFoto" width="200px" class="mb-1">
